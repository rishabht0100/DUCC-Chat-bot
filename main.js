var data= {
    chatinit:{
        ...
        options: ["Samarth","News","Shopping <span class='emoji'> &#128090;</span>","Music <span class='emoji'> &#127925;</span>"]
    },
    samarth: {
        title:["Please select category"],
        options:['Marksheet','Mail','Fee','Others'],
        url : {
    ...
    fee: {
        title: ["Thanks for your response","Here are some genre based Fee"],
        options: ["Comedy","Horror","Sci-Fi","Romance","Action"],
        url: {
            more:"https://www.youtube.com/@webhub/videos",
            link:["#","#","#","#","#"]
